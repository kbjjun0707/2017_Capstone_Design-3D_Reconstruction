/********************************************************************************
** Form generated from reading UI file 'pagescan.ui'
**
...
#ifndef UI_PAGESCAN_H
#define UI_PAGESCAN_H
...
public:
    ...
    void setupUi(QMainWindow *ScanClass)
    {
        if (ScanClass->objectName().isEmpty())
            ScanClass->setObjectName(QStringLiteral("ScanClass"));
        ScanClass->resize(888, 629);
        ScanClass->setMinimumSize(QSize(888, 629));
        ScanClass->setMaximumSize(QSize(888, 629));
        menuBack = new QAction(ScanClass);
        menuBack->setObjectName(QStringLiteral("menuBack"));
        menuQuit = new QAction(ScanClass);
        menuQuit->setObjectName(QStringLiteral("menuQuit"));
        menuColor = new QAction(ScanClass);
        menuColor->setObjectName(QStringLiteral("menuColor"));
        menuColor->setCheckable(true);
        menuColor->setChecked(false);
        menuView_Box = new QAction(ScanClass);
        menuView_Box->setObjectName(QStringLiteral("menuView_Box"));
        menuView_Box->setCheckable(true);
        menuView_Box->setChecked(true);
        menuOptions = new QAction(ScanClass);
        menuOptions->setObjectName(QStringLiteral("menuOptions"));
        centralwidget = new QWidget(ScanClass);
        ...
        ScanClass->setCentralWidget(centralwidget);
        menubar = new QMenuBar(ScanClass);
        ...
        menuTools->addAction(menuView_Box);
        menuTools->addAction(menuColor);
        menuTools->addSeparator();
        menuTools->addAction(menuOptions);

        retranslateUi(ScanClass);

        QMetaObject::connectSlotsByName(ScanClass);
    } // setupUi

    void retranslateUi(QMainWindow *ScanClass)
    {
        ScanClass->setWindowTitle(QApplication::translate("ScanClass", "3D Scanner", Q_NULLPTR));
        menuBack->setText(QApplication::translate("ScanClass", "Back", Q_NULLPTR));
        menuQuit->setText(QApplication::translate("ScanClass", "Quit", Q_NULLPTR));
        menuColor->setText(QApplication::translate("ScanClass", "Color", Q_NULLPTR));
        menuView_Box->setText(QApplication::translate("ScanClass", "View Box", Q_NULLPTR));
        menuOptions->setText(QApplication::translate("ScanClass", "Options", Q_NULLPTR));
        lb_disparity->setText(QString());
        lb_cmp->setText(QString());
        lb_std->setText(QString());
        lb_cam->setText(QString());
        btn_save->setText(QApplication::translate("ScanClass", "save", Q_NULLPTR));
        btn_clear->setText(QApplication::translate("ScanClass", "clear", Q_NULLPTR));
        btn_stop->setText(QApplication::translate("ScanClass", "pause", Q_NULLPTR));
        btn_start->setText(QApplication::translate("ScanClass", "Start", Q_NULLPTR));
        lb_reproject->setText(QString());
        menuFile->setTitle(QApplication::translate("ScanClass", "File", Q_NULLPTR));
        menuTools->setTitle(QApplication::translate("ScanClass", "Tools", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class ScanClass: public Ui_ScanClass {};
} // namespace Ui
